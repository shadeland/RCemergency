...
//                    extractStyles: true,
        ...
        this.map.setCenter(new OpenLayers.LonLat(app.lon,app.lat).transform(this.map.displayProjection, this.map.projection),10);
        this.renderMap();
...
//        this.collection.fetch();
    ...
    renderTrackLayer:function(){
        ...
        app.map.trackLayer.events.register("loadstart", app.map.trackLayer, function() {
            console.log('loadstart');
            } );
        app.map.trackLayer.events.register("loadend", app.map.trackLayer, function() {
    ...
    refreshTrackLayer:function(url){
//        this.trackUrl='http://shadeland.net/index.php/kml_service/order/'+SID;
        this.trackUrl='http://shadeland.net/index.php/kml_service/dataproxy/'+url;
