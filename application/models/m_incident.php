...
class M_incident extends CI_Model {
    ...
    function createIncident($incidentType,$pos_lat,$pos_lon,$pos_alt="",$validity,$descript){
//        print_r("slalan".$pos_lat);
         $this->load->model('m_position');
        $positionID=$this->m_position->createPosition($pos_lat,$pos_lon,$pos_alt);
        $this->db->set(array('incident_type_ID' => $incidentType,'position_ID' => $positionID,'validity' => $validity,'descript'=>$descript,'create_date'=>date("Y-m-d H:i:s")))->insert('incident');
